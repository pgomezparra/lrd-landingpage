  ...
  <div class="app-layout">
    ...
    <div class="sidebar">
      ...
      <div class="sidebar-menu-items">
        <div>
          <p  @click="redirectToHome">Inicio</p>
        </div>
        <div>
          <p  @click="redirectToDashBoard">Dashboard</p>
        </div>
        <div>
          <p  @click="redirectToPayments">Pagos</p>
        </div>
        ...
        <p @click="redirectToStudents" class="menu-item">Estudiantes</p>
      </div>
